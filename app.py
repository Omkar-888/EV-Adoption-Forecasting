...
st.markdown("""
    <div class='developer-info'>
        <div class='developer-title'>👨‍💻 Developer Information</div>
        <div class='developer-details'>
            <strong>Developer:</strong> Omkar Padhy<br>
            <strong>Email:</strong> 
            <span class='email-copy' onclick='navigator.clipboard.writeText("omkarpadhy88@gmail.com"); 
            this.innerHTML="📋 Email Copied!"; 
            setTimeout(() => this.innerHTML="📧 omkarpadhy88@gmail.com", 2000);'>
                omkarpadhy88@gmail.com
            </span>
        </div>
    </div>
""", unsafe_allow_html=True)

st.markdown("<div style='text-align: center;'>Prepared for the <strong>AICTE Internship Cycle 2 by S4F</strong></div>", unsafe_allow_html=True)
